...
<html lang="en">
<head>
  <title>David's Digital Den - Home</title>
  ...
  <style>
    ...
    *{ box-sizing: border-box; }
    ...
    @media (max-width: 640px){
      ...
      .dropdown-menu { position: static; border-left: none; border-right: none; }
    }
  </style>
</head>
...
<div class="top-wrap">
  ...
  <div class="content">
    <h1><b>Welcome to the Digital Den</b></h1>
    <h2>Popular Titles</h2>

    <div class="gallery">
      <div class="game-card">
        <a href="Skyrim.php">
          <img class="thumb" src="/Images/Skyrim.jpg" alt="Skyrim: The Elder Scrolls V">
        </a>
        <div class="title"><a href="Skyrim.php">Skyrim: The Elder Scrolls V</a></div>
        <span class="price">$20</span>
      </div>

      <div class="game-card">
        <a href="TheLastofUs.php">
          <img class="thumb" src="/Images/The Last of Us.jpg" alt="The Last of Us: Remastered">
        </a>
        <div class="title"><a href="TheLastofUs.php">The Last of Us: Remastered</a></div>
        <span class="price">$15</span>
      </div>

      <div class="game-card">
        <a href="WolfensteinNewOrder.php">
          <img class="thumb" src="/Images/Wolfenstein.jpg" alt="Wolfenstein: The New Order">
        </a>
        <div class="title"><a href="WolfensteinNewOrder.php">Wolfenstein: The New Order</a></div>
        <span class="price">$20</span>
      </div>
    </div>
  </div>
